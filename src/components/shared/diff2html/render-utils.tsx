...
import { File, Plus, Trash, ArrowRightCircle, Edit2 } from 'lucide-react'; // Importing icons from lucide-react
import {
    ColorSchemeType,
    DiffFile,
    DiffFileName,
...
/**
 * Create a React element from HTML string
 * Note: This is only used for highlighted content that already has HTML tags
 */
export function createReactElementFromHTML(html: string): React.ReactNode {
...
/**
 * Returns proper status text based on file status
 */
...
/**
 * Create SVG icon elements for file status
 */
export const FileIcons = {
    File: File,
    Added: Plus,
    Deleted: Trash,
    Renamed: ArrowRightCircle,
    Changed: Edit2,
};
